...
int main(){
    //variáveis globais
    int conjuntoA[100], conjuntoB[100], conjuntoAleatorio[100], conjuntoUniao[200], conjuntoInterseccao[100];
    int *P_conjuntoA = conjuntoA;
    int *P_conjuntoB = conjuntoB;
    int *P_conjuntoAleatorio = conjuntoAleatorio;
    int *P_conjuntoUniao = conjuntoUniao;
    int *P_conjuntoInterseccao = conjuntoInterseccao;

    preencheMenosUm(P_conjuntoA);
    preencheMenosUm(P_conjuntoB);
    preencheMenosUm(P_conjuntoAleatorio);
    preencheMenosUm(P_conjuntoUniao);
    preencheMenosUm(P_conjuntoInterseccao);
    ...
    while(escolha != 8){
        ...
        switch (escolha){
                ...
                switch (escolhaConjunto){
                    case 1:
                        ...
                        if(nElem > 100 || nElem < 0){
                            ...
                            preencherConjunto(P_conjuntoA, nElem);
                        }
                    break;
                    ...
                    case 2:
                        ...
                        if(nElem > 100 || nElem < 0){
                            ...
                            preencherConjunto(P_conjuntoB, nElem);
                        }
                    break;
            ...
            case 2:
                ...
                switch (escolhaConjunto){
                    case 1:
                        verificaVazio(P_conjuntoA);
                    break;
                
                    case 2:
                        verificaVazio(P_conjuntoB);
                    break;

                    case 3:
                        verificaVazio(P_conjuntoAleatorio);
                    break;

                    case 4:
                        verificaVazio(P_conjuntoUniao);
                    break;

                    case 5:
                        verificaVazio(P_conjuntoInterseccao); 
            ...
            case 4:
                ...
                switch (escolhaConjunto){
                    case 1:
                        imprimirConjunto(P_conjuntoA);
                    break;
                
                    case 2:
                        imprimirConjunto(P_conjuntoB);
                    break;

                    case 3:
                        imprimirConjunto(P_conjuntoAleatorio);
                    break;

                    case 4:
                        imprimirConjunto(P_conjuntoUniao);
                    break;

                    case 5:
                        imprimirConjunto(P_conjuntoInterseccao); 
                    break;
            ...
            case 5:
                preencherAleatorios(P_conjuntoAleatorio);
            break;
            ...
            case 6:
                ...
                scanf("%d", &escolhaConjunto);
                 if(escolhaConjunto < 0 || escolhaConjunto > 5){
                    ...
                    switch (escolhaConjunto){
                        case 1:
                            *escolhaUI1 = P_conjuntoA;
                        break;
                        
                        case 2:
                            *escolhaUI1 = P_conjuntoB;
                        break;
                        
                        case 3:
                            *escolhaUI1 = P_conjuntoAleatorio;
                        break;

                        case 4:
                            *escolhaUI1 = P_conjuntoUniao;
                        break;
                        case 5:
                            *escolhaUI2 = P_conjuntoInterseccao;
                        break;
                    }
                    }
                    if(trava != 1){
                        ...
                        scanf("%d", &escolhaConjunto);
                            switch (escolhaConjunto){
                            case 1:
                                *escolhaUI2 = P_conjuntoA;
                            break;
                            
                            case 2:
                                *escolhaUI2 = P_conjuntoB;
                            break;
                            
                            case 3:
                                *escolhaUI2 = P_conjuntoAleatorio;
                            break;

                            case 4:
                                *escolhaUI2 = P_conjuntoUniao;
                            break;
                            ...
                            if(trava != 1){
                                unirConjuntos(*escolhaUI1, *escolhaUI2, P_conjuntoUniao);
                            }
                    }
                trava = 0;
            ...
            case 7:
                ...
                if(escolhaConjunto < 0 || escolhaConjunto > 5){
                    ...
                    switch (escolhaConjunto){
                        ...
                        case 5:
                            *escolhaUI1 = P_conjuntoInterseccao;
                        break;
                ...
                if(trava != 1){
                    ...
                    scanf("%d", &escolhaConjunto);
                        ...
                        if(trava != 1){
                            interseccaoConjutos(*escolhaUI1, *escolhaUI2, P_conjuntoInterseccao);
                        } 
                    }
                trava = 0;
