...
int main(){
    ...
    struct conjunto *escolhaUI1, *escolhaUI2;
        ...
        switch (escolha){
            case 1:
                ...
                switch (escolhaConjunto){
                    case 1:
                        printf("Escolha o número de elementos a serem preenchidos\n");
                        scanf("%d", &nElem);
                        if(nElem < 0){
            ...
            case 5:
                printf("Escolha o número de elementos aleatórios a serem gerados: ");
                scanf("%d", &nElem);
                if(nElem < 0){
                    printf("Valor inválido! Retornando ao menu de opções.\n");
                }
                ...
                {
                preencherAleatorios(P_conjuntoAleatorio, nElem);
                }
            break;
